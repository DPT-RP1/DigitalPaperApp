...
/  options listed below can be set via cups-pdf-dpt.conf at runtime		*/
...
struct {
  ...
  { "AnonDirName", SEC_CONF|SEC_PPD, { "/var/spool/cups-pdf-dpt/ANONYMOUS" } },
  ...
  { "Out", SEC_CONF|SEC_PPD, { "/var/spool/cups-pdf-dpt" } },
  { "Spool", SEC_CONF|SEC_PPD, { "/var/spool/cups-pdf-dpt/SPOOL" } },
