...
public enum Command {
    ...
    ADB_FETCH_EXTENSION("adb fetch-extension", Collections.emptyList(), Arrays.asList("name", "local-path"), "Retrieve extension descriptors as returned by dpt adb list-extensions"),
